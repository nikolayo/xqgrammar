...
LAngle       : { !inTag }? => '<'  ;
RAngle       : {  inTag }? => '>'  { inTag = false; };
LClose       : { !inTag }? => '</' { inTag = true;  };
RClose       : {  inTag }? => '/>' { inTag = false; };
SymEq        : {  inTag }? => '=';
LCurly       : { !inTag || inAposAttr || inQuotAttr }? => '{';
RCurly       : { !inTag || inAposAttr || inQuotAttr }? => '}';
Quot         : {  inTag || inAposAttr }? => '"'  { inQuotAttr = !inQuotAttr; };
Apos         : {  inTag || inQuotAttr }? => '\'' { inAposAttr = !inAposAttr; };
EscapeQuot   : { inQuotAttr }? => '""';
EscapeApos   : { inAposAttr }? => '\'\'';
EscapeLCurly : { !inTag || inAposAttr || inQuotAttr }? => '{{';
EscapeRCurly : { !inTag || inAposAttr || inQuotAttr }? => '}}';
Colon        : ':';
